...
class TestExportQuerySetAsCsv(TestCase):
    def test_default_params(self):
        ...
        self.assertEqual(ret.content.decode('utf8'), '"%s";"Can add user";"user";"add_user"\r\n' % qs[0].pk)
    ...
    def test_queryset_values(self):
        ...
        mem.seek(0)
        csv_dump = mem.read()
        self.assertEqual(csv_dump.decode('utf8'), '"Name";"Application"\r\n"add_user";"auth"\r\n')
    ...
    def test_callable_method(self):
        ...
        mem.seek(0)
        csv_dump = mem.read()
        self.assertEqual(csv_dump.decode('utf8'), '"add_user";"(u\'add_user\', u\'auth\', u\'user\')"\r\n')
    ...
    def test_deep_attr(self):
        ...
        mem.seek(0)
        csv_dump = mem.read()
        self.assertEqual(csv_dump.decode('utf8'), '"add_user";"auth"\r\n')
...
class TestExportAsCsv(unittest.TestCase):
    def test_export_as_csv(self):
        ...
        mem.seek(0)
        csv_dump = mem.read()
        self.assertEqual(csv_dump.decode('utf8'), '"Field 1";"Field 2"\r\n"1";"4"\r\n"2";"5"\r\n"3";"ӼӳӬԖԊ"\r\n')
